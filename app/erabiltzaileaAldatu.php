...
<html lang="es">
 ...
 <body>
<form class="login-form" action="erabiltzaileAldaketaEgin.php" method="POST" >
  <p class="login-text">
    <img src="../irudiak/mendia.png"  width="90" >  
  <br/>
  </p>
  <p style="font-size: 20px;margin: 0px 0; color:white">Helbide elektronikoa:</p>
   <input type= "Email" name="Email" class="izena" id="id"<?php echo" value='{$email}'";?> readonly/>
   
  <p style="font-size: 20px;margin: 0px 0; color:white">Izen abizenak:</p>
  <input type="Izena" name="Izena" class="login-info" id="id" <?php echo" value='{$row['Izen abizenak']}'";?>/>
  
   <p style="font-size: 20px;margin: 0px 0; color:white">NAN:</p>
 <input type= "NAN" name="NAN" class="login-info" id="id" <?php echo" value='{$row['NAN']}''";?>/>
  
  <p style="font-size: 20px;margin: 0px 0; color:white">Telefonoa:</p>
 <input type= "Telefonoa" name="Telefonoa" class="login-info" id="id" <?php echo" value='{$row['Telefonoa']}''";?>/>
 
  <p style="font-size: 20px;margin: 0px 0; color:white">Jaiotze data:</p>
  <input type ="Jaiotza" name="Jaiotza" class="login-info" id="id" <?php echo" value='{$row['Jaiotze data']}'";?>/>
  
  <p style="font-size: 20px;margin: 0px 0; color:white">Pasahitza:</p>
  <input type= "Pasahitza"name="Pasahitza" class="login-info" id="id" <?php echo" value='{$row['Pasahitza']}''";?>/>
