...
<form class="login-form" action="erregistratu.php" method="POST" id="erregistroa">
  ...
  <input type="NAN" name="NAN" id="NAN" class="login-info" autofocus="true" required="true" placeholder="NAN" />
  ...
  <input type="Telefonoa" name="Telefonoa" id="Telefonoa" class="login-info" autofocus="true" required="true" placeholder="Telefonoa" />
  <input type="Email" name="Email" id="Email" class="login-info" autofocus="true" required="true" placeholder="Helbide elektronikoa" />
  <input type="Pasahitza"  name="Pasahitza1"  id="Pasahitza1" class="login-info" required="true" placeholder="Pasahitza" />
   <input type="Pasahitza"  name="Pasahitza2" id="Pasahitza2" class="login-info" required="true" placeholder="Pasahitza errepikatu" />
