...
<form class="login-form" method="POST" >        <!-- HAU ALDATU-->
  <p class="login-text">
             ...
             $id= $row['Id'];
                ...
                "<tr>
                 ...
                 <td class=letra><button id='btnModal' type='button'><a href='{$row['Link-a']}'>Link-a</button></td>          
                  ...
                  <td class=letra><button id='btnModal' type='button' class=ezabatu-submit><a href='ibilbideEzabaketaEgin.php?id={$row['Id']}'> Ezabatu</button></td>
                  
                   <td><button onclick='ezabatuKonfirmazioa(".$id.")'>Ezabatu</button></td> 
